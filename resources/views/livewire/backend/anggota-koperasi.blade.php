        ...
        @can('create anggota')
            <form action="" wire:submit.prevent="{{ $editStatus ? 'updateHandler' : 'submitHandler' }}"
                ...
                <div class="flex flex-col">
                    ...
                    <input class="w-full border border-gray-400/50 rounded-md px-2 py-1 flex items-center mb-2" type="text"
                        wire:model='no_kk' placeholder="No KK">
                    @error('no_kk')
                        <p class="text-red-500 italic text-sm">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <input class="w-full border border-gray-400/50 rounded-md px-2 py-1 flex items-center mb-2" type="date"
                        wire:model='ttl' placeholder="Tanggal Lahir">
                    @error('ttl')
                        <p class="text-red-500 italic text-sm">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <input class="w-full border border-gray-400/50 rounded-md px-2 py-1 flex items-center mb-2" type="number"
                        wire:model='no_telp' placeholder="Nomor Telp">
                    @error('no_telp')
                        <p class="text-red-500 italic text-sm">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <input class="w-full border border-gray-400/50 rounded-md px-2 py-1 flex items-center mb-2" type="text"
                        wire:model='kecamatan' placeholder="Kecamatan">
                    @error('kecamatan')
                        <p class="text-red-500 italic text-sm">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <input class="w-full border border-gray-400/50 rounded-md px-2 py-1 flex items-center mb-2" type="text"
                        wire:model='kelurahan' placeholder="Kelurahan">
                    @error('kelurahan')
                        <p class="text-red-500 italic text-sm">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <input class="w-full border border-gray-400/50 rounded-md px-2 py-1 flex items-center mb-2" type="text"
                        wire:model='kabupaten' placeholder="Kabupaten">
                    @error('kabupaten')
                        <p class="text-red-500 italic text-sm">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <input class="w-full border border-gray-400/50 rounded-md px-2 py-1 flex items-center mb-2" type="text"
                        wire:model='provinsi' placeholder="Provinsi">
                    @error('provinsi')
                        <p class="text-red-500 italic text-sm">{{ $message }}</p>
                    @enderror
                </div>
