<div class="overflow-hidden">
    ...
    <form action="" wire:submit.prevent="submitBayar" class="">
        ...
        <div class="shadow-md shadow-gray-500/50 rounded-md border border-gray-400/50 p-2 text-sm italic capitalize ">
            <div class="md:grid-cols-2 lg:grid-cols-5 grid grid-cols-1 gap-x-2 overflow-auto">
                ...
                <div>
                    ...
                    <input wire:keyup="bayar_change()" autofocus type="text" focus wire:model="besar_pembayaran"
    ...
    <div class="border lg:text-base text-sm border-gray-400/50 shadow-md shadow-gray-500/50 rounded-md p-3 my-2">
        ...
        <div class="border-b border-gray-600/50 py-3 w-full">
            <p>Nama Pinjaman :<span class="font-bold text-right">{{ $lihatpembayaran->profile->nama_lengkap }}</span>
            </p>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full">
                            ...
                            <tbody>
                                ...
                                @foreach ($lihatpembayaran->pembayaran_user->detail_pembayaran_user()->get() as $no =>
                                $item)
                                <?php $nor = $no + 1; ?>
                                <tr class="border-b border-gray-400/50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        ...
                                        <button data-bs-dismiss="modal" wire:click="deletePembayaran({{ $item->id }})"
