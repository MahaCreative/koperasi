<div>
    <footer class="text-center bg-primary text-white">
        <div class="container px-6 pt-3">
            <div class="flex justify-center mb-6 text-2xl font-extrabold">
            ...
            <div class="mb-6">
                <p>
                    Bersama Koperasi Berkah Sejahtera, Mengajukan Pinjaman Cepat Mudah Dan Aman
                </p>
            </div>
        ...
        <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2022 Copyright:
            <a class="text-white" href="https://tailwind-elements.com/">Srimulka</a>
        </div>
    </footer>
</div>
